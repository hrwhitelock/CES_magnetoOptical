...
ax2 = subplot(2,1,2);
hold on; 
[X,Y] = meshgrid(my_spec_data.calc_wavenums, linspace(0,18,90));
X = linspace(0,18,90); 
Vq = interp2(X, my_spec_data.calc_wavenums, my_spec_data.simulated_IR_B,linspace(0,18.5, 1000),linspace(0, 100, 10000));
